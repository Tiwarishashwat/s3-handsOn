...
export class UserComponent implements OnInit {
  ...
  addUser(): void {
    ...
    this.deleteStatus = false;
    this.updateStatus = false;
    let user: User = {"id":29,"email":"500062208@upes.ac.in","first_name":"Shashwat","last_name":"Tiwari","avatar":"https://reqres.in/img/faces/7-image.jpg"};
  ...
  updateUser(): void {
    ...
    let user:User = {"id":7,"email":"shash.78@stu.upes.ac.in","first_name":"Ayushi","last_name":"Sharma","avatar":""};
